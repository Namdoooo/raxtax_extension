# Benchmark: Query Count vs Runtime
...
```
python -m benchmarks_hits.query_count_benchmark.main
```

After completion, analysis and plotting can be performed with:

```
python -m benchmarks_hits.query_count_benchmark.analyze
```
...
- `query_count_vs_calculate_intersection_sizes_time.pdf`  
  Final plot showing the relationship between query count and runtime.
