# Benchmark: Thread Count vs Memory Usage

## Purpose
This benchmark evaluates how the peak memory usage of the extended
raxtax workflow scales with an increasing number of cores.
The objective is to assess the impact of core count on memory usage.
...
- `threads_vs_memory.pdf`  
  Final plot showing the relationship between core count and memory usage.
